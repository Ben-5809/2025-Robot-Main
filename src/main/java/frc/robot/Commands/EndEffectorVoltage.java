...
public class EndEffectorVoltage extends Command {
  private CoralEndEffector coralEndEffector;
  private LEDsub ledSub;
  private int[] colorApplied;
  private double motorVoltage;

  public EndEffectorVoltage(CoralEndEffector coralEndEffector, LEDsub ledSub, int[] colorApplied, double motorVoltage) {
